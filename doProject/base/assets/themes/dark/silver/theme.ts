...
export const silverTheme: ThemeScheme = {
  name: 'silver',
  mode: 'dark',
  style:
  {
    root: {
      '--ion-color-primary': '#dedede',
      '--ion-color-primary-rgb': '222,222,222',
      '--ion-color-primary-contrast': '#000000',
      '--ion-color-primary-contrast-rgb': '0,0,0',
      '--ion-color-primary-shade': '#c3c3c3',
      '--ion-color-primary-tint': '#e1e1e1',

      '--ion-color-secondary': '#adadad',
      '--ion-color-secondary-rgb': '173,173,173',
      '--ion-color-secondary-contrast': '#000000',
      '--ion-color-secondary-contrast-rgb': '0,0,0',
      '--ion-color-secondary-shade': '#989898',
      '--ion-color-secondary-tint': '#b5b5b5',

      '--ion-color-tertiary': '#5c5c5c',
      '--ion-color-tertiary-rgb': '92,92,92',
      '--ion-color-tertiary-contrast': '#ffffff',
      '--ion-color-tertiary-contrast-rgb': '255,255,255',
      '--ion-color-tertiary-shade': '#515151',
      '--ion-color-tertiary-tint': '#6c6c6c',
