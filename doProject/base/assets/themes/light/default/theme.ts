...
export const defaultLightTheme: ThemeScheme = {
  name: 'default',
  mode: 'light',
  style:
    {
      root: {
        ...
        // Colors generated via tool': 'https':/'/ionicframework.com/docs/theming/advance'd
        ...
        '--background-text-area': '#eeeeee',
        '--color-text-area': '#000000',
        ...
        '--ion-border-color-rgb': '221, 221, 221',

        //  Pick map
        // search results
        '--search-result-background-color': '#ffffff',

        //  Reservar
        '--footer-background-animado': '#d9d9d9',

        '--ion-toolbar-background': '#f2f2f2',
        '--ion-item-background': '#ffffff',
        '--ion-tab-bar-background': '#f2f2f2',
        '--ion-card-background': '#f2f2f2',

        '--ion-item-divider-background-color': '#f2f1f6',
      },
      ios: {},
      md: {},
    },
